...
export default function NavBar() {
  ...
  return (
    <div className="w-full  fixed z-10 my-5 justify-center flex items-center bg  ">
      <ul className="flex bg-gradient-to-tr from-gray-600 via-gray-700 to-gray-900 text-xs sm:text-sm font-semibold px-3 rounded-full max-w-fit bg-[#1A1A1A]  mx-[10%]  mb-[8%]   items-center">
        {NavItem.map((item) => (
          <li
